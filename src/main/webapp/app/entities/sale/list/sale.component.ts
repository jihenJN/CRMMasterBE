...
export class SaleComponent implements OnInit {
  ...
  trackId = (_index: number, item: ISale): string => this.saleService.getSaleIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.sales = this.refineData(dataFromBody);
  }

  protected refineData(data: ISale[]): ISale[] {
